...
export const expansions = {
  ...
  airline: {
    dice: ['Sky/images/sky_airportA_', 'Sky/images/sky_airportB_'],
    effective_dice: 0,
  },
  'alien-farmer': {
  ...
  canyon: {
    dice: ['Yellow/images/yellow_canyonA_', 'Yellow/images/yellow_canyonA_'],
    effective_dice: 0,
  },
  'city-builder': {
    dice: [
      'Future/images/future_cityBuilderA_',
  ...
  desert: {
    dice: ['Yellow/images/yellow_desertA_', 'Yellow/images/yellow_desertB_'],
    effective_dice: 1,
  },
  forest: {
    dice: ['Green/images/green_forestA_', 'Green/images/green_forestA_'],
    effective_dice: 2,
  },
  'galactic-invaders': {
  ...
  lake: {
    dice: ['Blue/images/blue_lakeA_', 'Blue/images/blue_lakeA_'],
    effective_dice: 2,
  },
  lava: {
    dice: ['Red/images/red_lavaA_', 'Red/images/red_lavaA_'],
    effective_dice: 2,
  },
  meteor: {
    dice: ['Red/images/red_meteorA_', 'Red/images/red_meteorB_'],
    effective_dice: 1,
  },
  'pluck-man': {
  ...
  river: {
    dice: ['Blue/images/blue_riverA_', 'Blue/images/blue_riverA_'],
    effective_dice: 2,
  },
  separation: {
  ...
  trail: {
    dice: ['Green/images/green_trailsA_', 'Green/images/green_trailsA_'],
    effective_dice: 2,
  },
  underground: {
    dice: [
      'Underground/images/underground_defaultA_',
  ...
  weather: {
    dice: ['Sky/images/sky_weatherA_', 'Sky/images/sky_weatherA_'],
    effective_dice: 0,
  },
};
