...
const rulesResData: { [key: string]: { [key: string]: string } } = {
  goals: {
    ...
    blue_riverB:
      '<p>Have 3 Stations orthogonally adjacent to River spaces.</p>',
    blue_riverC: '<p>Connect 2 Exits with a Route that goes over a River.</p>',
    classic_defaultA:
      '<p>Draw anything in at least 5 of the Central Spaces of your board (the spaces don’t need to be connected to each other, just in the Central Area).</p>',
    classic_defaultB:
      '<p>Activate 3 Villages by drawing a Station inside their spaces.</p>',
    classic_defaultC:
      '<p>Draw anything in all of the spaces of a single row or column of your board (the spaces don’t need to be connected to each other, just in the same row/column).</p>',
    classic_defaultD:
      '<p>Draw anything in at least 3 of the corner spaces of your board.</p>',
    classic_defaultE:
      '<p>Draw anything in all of the spaces of a 3x3 area on your board (the spaces don’t need to be connected to each other, just in the same 3x3 area).</p>',
    classic_defaultF:
      '<p>Create a circular path that starts and ends at the same point.</p>',
    ...
    classic_defaultK:
      '<p>Connect at least 2 Exits on the opposite sides of the board to each other.</p>',
    classic_defaultL:
      '<p>Connect at least 2 Exits in the middle of their side of the board to each other.</p>',
    cthulu_portalA: '<p>Have 3 Portals on spaces with a University.</p>',
    cthulu_portalB:
      '<p>Create a Network that loops through matching Portals.</p>',
    cthulu_portalC: '<p>Have three orthogonally adjacent Portals.</p>',
    green_forestA:
      '<p>Draw at least 5 separate Forests (they can be merged after you achieve this goal.</p>',
    green_forestB:
      '<p>Draw an uninterrupted streak of 4 diagonally adjacent spaces with trees inside</p>',
    green_forestC: '<p>Draw Trees in at least 4 spaces adjacent to Exits</p>',
    green_trailsA:
      '<p>Draw Trails in 5 adjacent spaces on the same row or column (the spaces don’t need to be connected to each other, just adjacent).</p>',
    green_trailsB: '<p>Connect at least 3 Trails to the same Station.</p>',
    green_trailsC:
      '<p>Draw Trails in 5 spaces in the Central Area of your board (the spaces don’t need to be connected to each other, just in the Central Area).</p>',
    ...
    yellow_canyonC:
      '<p>Draw a Canyon with both ends connected to the edge of the board that also goes through the Central Area of your board.</p>',
    yellow_desertA:
      '<p>Draw Cacti in all of the spaces of a 2x2 area on your board (the spaces don’t need to be connected to each other, just in the same 2x2 area).</p>',
    yellow_desertB:
      '<p>Draw Cacti in at least 4 adjacent spaces in a single row or column of your board (the spaces don’t need to be connected to each other, just in the same row/column).</p>',
    yellow_desertC:
      '<p>Connect at least 3 spaces containing an Oasis to the same network.</p>',
  },
  expansions: {
    none: '<p></p>',

    airline:
      '<h1>Airline Expansion:</h3>' +
    ...
    'galactic-invaders':
      '<h1>Galactic Invaders Expansion:</h3>' +
    ...
    superconnection:
      '<h1>superconnection Expansion:</h3>' +
      `
