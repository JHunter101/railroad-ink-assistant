...
const rulesResData = {
    goals: {
        ...
        classic_defaultA: 'Draw anything in at least 5 of the Central Spaces of your board (the spaces don’t need to be connected to each other, just in the Central Area).',
        classic_defaultB: 'Activate 3 Villages by drawing a Station inside their spaces.',
        classic_defaultC: 'Draw anything in all of the spaces of a single row or column of your board (the spaces don’t need to be connected to each other, just in the same row/column).',
        classic_defaultD: 'Draw anything in at least 3 of the corner spaces of your board.',
        classic_defaultE: 'Draw anything in all of the spaces of a 3x3 area on your board (the spaces don’t need to be connected to each other, just in the same 3x3 area).',
        classic_defaultF: 'Create a circular path that starts and ends at the same point.',
        ...
        classic_defaultK: 'Connect at least 2 Exits on the opposite sides of the board to each other.',
        classic_defaultL: 'Connect at least 2 Exits in the middle of their side of the board to each other.',
        ...
        green_forestA: 'Draw at least 5 separate Forests (they can be merged after you achieve this goal.',
        green_forestB: 'Draw an uninterrupted streak of 4 diagonally adjacent spaces with trees inside',
        green_forestC: 'Draw Trees in at least 4 spaces adjacent to Exits',
        green_trailsA: 'Draw Trails in 5 adjacent spaces on the same row or column (the spaces don’t need to be connected to each other, just adjacent).',
        green_trailsB: 'Connect at least 3 Trails to the same Station.',
        green_trailsC: 'Draw Trails in 5 spaces in the Central Area of your board (the spaces don’t need to be connected to each other, just in the Central Area).',
        ...
        yellow_canyonC: 'Draw a Canyon with both ends connected to the edge of the board that also goes through the Central Area of your board.',
        yellow_desertA: 'Draw Cacti in all of the spaces of a 2x2 area on your board (the spaces don’t need to be connected to each other, just in the same 2x2 area).',
        yellow_desertB: 'Draw Cacti in at least 4 adjacent spaces in a single row or column of your board (the spaces don’t need to be connected to each other, just in the same row/column).',
        yellow_desertC: 'Connect at least 3 spaces containing an Oasis to the same network.',
    },
    expansions: {
        none: '',
